...
public class Controller {
    ...
    public void initialize() {
        ...
        studentListView.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<Student>() {
            ...
            public void changed(ObservableValue<? extends Student> observable, Student oldValue, Student newValue) {
                ...
                */
                yearStudyView.setText(studentListView.getSelectionModel().getSelectedItem().getYearOfStudy());
                mod1View.setText(studentListView.getSelectionModel().getSelectedItem().getModule1());
                mod2View.setText(studentListView.getSelectionModel().getSelectedItem().getModule2());
                mod3View.setText(studentListView.getSelectionModel().getSelectedItem().getModule3());
            }
        });
    ...
    public void getChoice(ActionEvent event) {
        ...
        if(event.getSource().equals(mod2Choice)) choice2 = mod2Choice.getSelectionModel().getSelectedItem();
        if(event.getSource().equals(mod3Choice)) choice3 = mod3Choice.getSelectionModel().getSelectedItem();
    }
    ...
    public void addStudentData() {
         ...
         */
        //do the if...here
        if(studIdS.trim().isBlank() || yearStudyS.trim().isBlank())
    ...
    public void deleteStudent(Student stu) {
        ...
        if(result.isPresent() && result.get()==ButtonType.OK/*result.equals(ButtonType.OK)*/)
    ...
    public void editStudent(Student stu) {
        ...
        try {
            ...
            /* TODO: print an appropriate message if it cannot be loaded
                     print stacktrace
             */
            System.out.println("could not b loaded");
